...
### shp data from files
# library(rgdal)
dir.shp <- paste0(dir.root, "/data/update_0503_SUM_dist/_input_data/ne_10m_admin_0_countries"); dir.shp
...
library(readxl)
xls.shp.info <- paste0(dir.root, '/data/update_0503_SUM_dist/_input_data/ne_10m_admin_0_countries/Table/ne_10m_admin_0_countries-Export_Output.xls')
...
### save the shp for other use ------------------------- #
shp_wiod <- shp_newName %>%
  dplyr::select(ADM0_A3, NAME, nation_name)
fname <- paste0(dir.root, '/data/data_myRData/', 'shp_wiod.RData'); fname
save(shp_wiod, file = fname)
### ---------------------------------------------------- #
